...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="billets.php">Reservation Billet 
    ...
    <div class="container">
        ...
        <div class="billet">
            <br>
            <h2 align="center">Liste des Reservations de Billet</h2>
            <br><br>
            <center>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        while ($data = $recup->fetch()) {
                            ...
                            <td>
                                <?php echo $data['classevoyage'] ?>
                            </td>
                            <td>
                                <?php echo $data['datevoyage'] ?>
                            </td>
                            <td>
                                <?php echo $data['statut'] ?>
                            </td>
                            <td>
                                <form action="deleteBillet.php" method="POST"><button name="id"
                                        value="<?php echo $data['id'] ?>"
                                        style="background-color: transparent;  color: rgb(77, 160, 205);  cursor: pointer; border: none;">Delete
                                    </button></form>
                                <form action="updateBillet.php" method="POST"> <button name="id"
                                        value="<?php echo $data['id'] ?>"
